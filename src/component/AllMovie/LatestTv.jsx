...
const productPerPage = 2; // Adjust the number of products per page as needed

// const indexOfLastProduct = currentPage * productPerPage;
// const indexOfFirstProduct = indexOfLastProduct - productPerPage;
// const currentProducts =LatestData.slice(indexOfFirstProduct, indexOfLastProduct);
              ...
              <Link key={index} to={`/alllatestdetails/${item.id}`}>
                <div>
                  <div className="relative group">
                    <img src={item.img} alt="" className="w-[165px] h-60 border-zinc rounded-lg border border-2 transform transition-transform hover:scale-110"/>
